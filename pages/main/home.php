    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="intro-slide" src="./assets/image/banner/ban1.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Chúng tôi cung cấp các công cụ, nguyên liệu và kiến thức để bạn sáng tạo bất kỳ chiếc bánh nào bạn muốn"</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/ban2.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Chúng tôi không chỉ cung cấp đồ dùng làm bánh, mà còn cung cấp đam mê và niềm tin vào nghệ thuật làm bánh"</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/ban3.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Với chúng tôi, việc làm bánh trở nên dễ dàng và đầy niềm vui"</p>
              </div>
            </div>
          </div>
        </div>
